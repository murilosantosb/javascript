...
btn_add.addEventListener('click',(evt)=>{
    ...
    carrinhoDeCompras.push(produtoPreco.value)
    
    let valorTotal = carrinhoDeCompras.reduce((anterior,atual,array)=>{
        let atualizar =  anterior + atual
        return totalCarinho.innerHTML = ` ${atualizar}R$`
        //totalCarinho.innerHTML = `Total: ${atualizar}`
